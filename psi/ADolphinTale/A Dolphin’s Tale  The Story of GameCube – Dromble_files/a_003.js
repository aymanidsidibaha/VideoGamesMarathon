...
var HighlanderComments = jQuery.extend( HighlanderComments, {
	...
	init : function() {
		...
		pm.bind( 'googlePlusButtonClick', HighlanderComments.onGooglePlusButtonClick, 'https://web.archive.org/web/20170508120750/https://public-api.wordpress.com/' );
		pm.bind( 'googlePlusSignIn', HighlanderComments.onGooglePlusSignIn, 'https://web.archive.org/web/20170508120750/https://public-api.wordpress.com/' );
		...
		jQuery( 'textarea#comment' )
			...
			.one( 'focus', function() {
				...
				pm( {
					...
					data: 0,
					url: 'https://web.archive.org/web/20170508120750/https://public-api.wordpress.com/'
				} );
			});
...
//		HighlanderComments.autosaveComment();
	...
	updateAvatarWithGravatar: function(e) {
		var grav_base = ( 'https:' === location.protocol ? 'https://web.archive.org/web/20170508120750/https://secure/' : 'https://web.archive.org/web/20170508120750/http://www/' ) + '.gravatar.com/avatar/';
			...
			jQuery( '#comment-form-' + service + ' .comment-form-avatar img' )
				.attr( 'src', function() {
					...
					try {
						...
						url = location.protocol + '//web.archive.org/web/20170508120750/https://i0.wp.com/' + host + '/' + path + '?';
	...
	doExternalCanceled : function( service, from_tab ) {
		if ( from_tab ) {
			var gravSource = ( 'https:' === location.protocol ? 'https://web.archive.org/web/20170508120750/https://secure/' : 'https://web.archive.org/web/20170508120750/http://www/' ) + '.gravatar.com/avatar/ad516503a11cd5ca435acc9bb6523536?s=25';
			if ( 'gravatar_default' !== HighlanderComments.gravDefault ) {
				gravSource += '&d=' + encodeURIComponent( HighlanderComments.gravDefault );
			}
	...
	doExternalLogout : function( service ) {
		...
		if ( 'googleplus' == service ) {
			jQuery( 'body' ).append( '<iframe height="1" width="1" style="display:none;" src="https://web.archive.org/web/20170508120750/https://accounts.google.com/logout" />' );
		}
	},
...
/*
     FILE ARCHIVED ON 12:07:50 May 08, 2017 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 13:26:28 Dec 29, 2017.
