...
function Ld(a){p.processGoogleToken=p.processGoogleToken||function(a,c){var b=a,e=c;b=void 0===b?{}:b;e=void 0===e?0:e;var f=b.newToken||"",g=parseInt(b.freshLifetimeSecs||"",10)||3600,h=parseInt(b.validLifetimeSecs||"",10)||86400,k=b["1p_jar"]||"";b=b.pucrd||"";Id();1==e?O.La():O.Ka();if(1E-5>Math.random()){var m="https://web.archive.org/web/20171008131835/https://pagead2.googlesyndication.com/pagead/gen_204?id=imerr&err="+e;p.google_image_requests||(p.google_image_requests=[]);var u=p.document.createElement("img");u.src=m;p.google_image_requests.push(u)}if(!f&&
...
ge("//web.archive.org/web/20171008131835/https://static.doubleclick.net/instream/ad_status.js",a);Ue.push(Se(function(){Ve||"google_ad_status"in window||(me("//web.archive.org/web/20171008131835/https://static.doubleclick.net/instream/ad_status.js",a),P("DCLKSTAT",3))},1))}
...
yh.prototype.l=function(){df(this.i);this.b=null;yh.o.l.call(this)};function zh(){var a=Xa(window,"settings","experiments","flags","html5_serverside_pagead_id_sets_cookie")||Q("EXP_HTML5_SERVERSIDE_PAGEAD_ID_SETS_COOKIE",!1)||T("html5_serverside_pagead_id_sets_cookie")?"//web.archive.org/web/20171008131835/https://googleads.g.doubleclick.net/pagead/id?exp=nomnom":"//web.archive.org/web/20171008131835/https://googleads.g.doubleclick.net/pagead/id",b=bb(Ah);return new J(function(c,d){b.C=function(a){ue(a)?c(a):d(new Bh("Request failed, status="+a.status,"net.badstatus"))};
...
X);for(var Ed in Ea)d[Ed]=Ea[Ed]}void 0!==b&&(d.bid=b);void 0!==a&&(d.mutsuid=a);d.bsq=Rh++;Ie("//web.archive.org/web/20171008131835/https://www.youtube.com/ad_data_204",{za:!1,w:d})}});
...
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();Q("PL_ATT")&&(ne=null);a=0;for(var b=Ue.length;a<b;a++)Te(Ue[a]);Ue.length=0;le("//web.archive.org/web/20171008131835/https://static.doubleclick.net/instream/ad_status.js");Ve=!1;P("DCLKSTAT",0);pc(Xh,Wh);if(a=Vh)a.removeEventListener("onScreenChanged",ai),a.removeEventListener("onLogClientVeCreated",$h),a.removeEventListener("onLogServerVeCreated",bi),a.removeEventListener("onLogToGel",Zh),a.removeEventListener("onLogVeClicked",ci),a.removeEventListener("onLogVesShown",di),a.removeEventListener("onReady",
ei),a.destroy();Yh={}});
...
/*
     FILE ARCHIVED ON 13:18:35 Oct 08, 2017 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 13:26:40 Dec 29, 2017.
